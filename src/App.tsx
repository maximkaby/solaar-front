...
import SolaarIBO from "./views/SolaarIBO/SolaarIBO";
...
import { IBOProvider } from "./context/IBOContext";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on ibo.solaarprotocol.com"));
    }
  }, []);
        ...
        <div className="wrap-app">
          <div className={`app ${isSmallerScreen && "tablet"} ${isSmallScreen && "mobile"} ${theme}`}>
            ...
            <nav className={classes.drawer}>
              {isSmallerScreen || location.pathname === '/' ? (
            ...
            <div className={`${classes.content} ${(isSmallerScreen || location.pathname === '/')  && classes.contentShift}`}>
              <Switch>
