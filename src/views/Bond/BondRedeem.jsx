...
import { trim, secondsUntilBlock, prettifySeconds, prettyVestingPeriod, prettyVestingPeriodTime } from "../../helpers";
...
function BondRedeem({ bond }) {
  ...
  const vestingTime = () => {
    return prettyVestingPeriodTime(bondDetails);
  };
        ...
        <Box className="bond-data">
          <div className="data-row">
            ...
            <Typography className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.interestDue, 4)} ${TOKEN_NAME}`}
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
            ...
            <Typography id="claimable" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.pendingPayout, 4)} ${TOKEN_NAME}`}
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
